...
public class landolt3 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.landolt3);
           ...
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	  ...
        	  // Toast.makeText(amsler.this, "pass step1...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(landolt3.this,landolt4.class);
        	   startActivity(i);
        	   finish();
           }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   landolt.lcounter=0; 
        	   Intent i=new Intent(landolt3.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
           }
        });
