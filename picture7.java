...
public class picture7 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picture7);
        ...
        next.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   //Toast.makeText(picture7.this, "pass step2...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(picture7.this,picture8.class);
        	   startActivity(i);
          	   finish();
           }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   picture.pcounter=0;
        	   Intent i=new Intent(picture7.this,MainActivity.class);
        	   startActivity(i);
          	   finish();
           }
        });
