...
public class visual9 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.visual9);
        ...
        next.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   Intent i=new Intent(visual9.this,visual10.class);
        	   startActivity(i);
        	   finish();
           }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   visual.vcounter=0;
        	   Intent i=new Intent(visual9.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
           }
        });
