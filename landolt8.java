...
public class landolt8 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.landolt8);
           ...
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	  ...
        	  // Toast.makeText(amsler.this, "pass step1...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(landolt8.this,landolt9.class);
        	   startActivity(i);
        	   finish();
           }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   landolt.lcounter=0; 
        	   Intent i=new Intent(landolt8.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
           }
        });
