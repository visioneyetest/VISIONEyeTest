...
public class amsler2 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.amsler2);
        ...
        next.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   Toast.makeText(amsler2.this, "pass step3...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(amsler2.this,amsler3.class);
        	   startActivity(i);
        	   finish();
        	   }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   amsler.counter=0;
        	   Intent i=new Intent(amsler2.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
        	   }
        });
