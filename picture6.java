...
public class picture6 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picture6);
        ...
        next.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   Toast.makeText(picture6.this, "pass step2...",3 ).show();
        	   Intent i=new Intent(picture6.this,picture7.class);
        	   startActivity(i);
          	   finish();
           }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   picture.pcounter=0;
        	   Intent i=new Intent(picture6.this,MainActivity.class);
        	   startActivity(i);
          	   finish();
           }
        });
