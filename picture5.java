...
public class picture5 extends Activity 
{
        ...
        next.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	  ...
        	  // Toast.makeText(picture5.this, "pass step2...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(picture5.this,picture6.class);
        	   startActivity(i);
          	   finish();
           }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   picture.pcounter=0;
        	   Intent i=new Intent(picture5.this,MainActivity.class);
        	   startActivity(i);
          	   finish();
           }
        });
