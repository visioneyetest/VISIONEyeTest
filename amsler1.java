...
public class amsler1 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.amsler1);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   Toast.makeText(amsler1.this, "pass step2...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(amsler1.this,amsler2.class);
        	   startActivity(i);
        	   finish();
        	   }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   amsler.counter=0;
        	   Intent i=new Intent(amsler1.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
        	   }
        });
