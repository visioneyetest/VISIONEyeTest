...
public class amsler extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.amsler);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   Intent i=new Intent(amsler.this,amsler1.class);
        	   startActivity(i);
        	   finish();
           }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   Toast.makeText(getBaseContext(), "Sorry.....You are fail.... Your score is="+counter, 4).show();
        	   counter=0;
        	   Intent i=new Intent(amsler.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
           }
        });
