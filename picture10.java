...
public class picture10 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picture10);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   //Toast.makeText(picture10.this, "pass step15...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(picture10.this,picture11.class);
        	   startActivity(i);
          	   finish();
           }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   picture.pcounter=0;
        	   Intent i=new Intent(picture10.this,MainActivity.class);
        	   startActivity(i);
          	   finish();
           }
        });
