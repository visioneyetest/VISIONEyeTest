...
public class ishihara3 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ishihara3);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   Intent i=new Intent(ishihara3.this,ishihara4.class);
        	   startActivity(i);
        	   finish();
           }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   ishihara.icounter=0;
        	   Intent i=new Intent(ishihara3.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
           }
        });
