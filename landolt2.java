...
public class landolt2 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.landolt2);
           ...
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	  ...
        	  // Toast.makeText(amsler.this, "pass step1...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(landolt2.this,landolt3.class);
        	   startActivity(i);
        	   finish();
           }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   landolt.lcounter=0; 
        	   Intent i=new Intent(landolt2.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
           }
        });
