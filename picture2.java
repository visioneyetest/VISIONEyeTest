...
public class picture2 extends Activity 
{
        ...
        b1.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   //Toast.makeText(picture2.this, "pass step2...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(picture2.this,picture3.class);
        	   startActivity(i);
          	   finish();
          	   }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   picture.pcounter=0;
        	   Intent i=new Intent(picture2.this,MainActivity.class);
        	   startActivity(i);
          	   finish();
          	   }
        });
