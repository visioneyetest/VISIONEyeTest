...
public class visual7 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.visual7);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   Intent i=new Intent(visual7.this,visual8.class);
        	   startActivity(i);
        	   finish();
           }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   visual.vcounter=0;
        	   Intent i=new Intent(visual7.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
           }
        });
