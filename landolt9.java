...
public class landolt9 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.landolt9);
           ...
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	  ...
        	  // Toast.makeText(amsler.this, "pass step1...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(landolt9.this,landolt10.class);
        	   startActivity(i);
        	   finish();
           }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   landolt.lcounter=0; 
        	   Intent i=new Intent(landolt9.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
           }
        });
