...
public class ishihara9 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ishihara9);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   Intent i=new Intent(ishihara9.this,ishihara10.class);
        	   startActivity(i);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   ishihara.icounter=0;
        	   Intent i=new Intent(ishihara9.this,MainActivity.class);
        	   startActivity(i);
