...
public class picture11 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picture11);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   //Toast.makeText(picture11.this, "pass step2...",Toast.LENGTH_LONG ).show();
        	   Intent i=new Intent(picture11.this,picture12.class);
        	   startActivity(i);
          	   finish();
           }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   picture.pcounter=0;
        	   Intent i=new Intent(picture11.this,MainActivity.class);
        	   startActivity(i);
          	   finish();
           }
        });
