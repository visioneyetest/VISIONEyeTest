...
public class ishihara11 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ishihara11);
        ...
        next.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   Intent i=new Intent(ishihara11.this,ishihara12.class);
        	   startActivity(i);
        	   finish();
           }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   ishihara.icounter=0;
        	   Intent i=new Intent(ishihara11.this,MainActivity.class);
        	   startActivity(i);
        	   finish();
           }
        });
