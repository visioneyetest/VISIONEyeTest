...
public class picture8 extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picture8);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
             ...
             //  txtView.setText("Test Pass......");
        	   ...
        	   Toast.makeText(picture8.this, "pass step2...",3 ).show();
        	   Intent i=new Intent(picture8.this,picture9.class);
        	   startActivity(i);
          	   finish();
           }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
            ...
            // txtView.setText("Test Fail......");
        	   ...
        	   picture.pcounter=0;
        	   Intent i=new Intent(picture8.this,MainActivity.class);
        	   startActivity(i);
          	   finish();
           }
        });
